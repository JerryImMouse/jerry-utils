...
/// For example <see cref="Project.Utilities.IoC.Default.DependencyCollection"/> will be initialized in ~4 microseconds instead of ~500.<br /><br/>
/// So I hardly not recommend you to use this if you often need to add dependencies to collection.<br /><br/> Use <see cref="Project.Utilities.IoC.Default.DependencyCollection"/> instead.
/// </summary>
